...
/*
	...
	dst_z = dst_z > PARAM::interaction_height ? dst_z : PARAM::interaction_height;
	dst_z = dst_z < PARAM::cruise_height ? dst_z : PARAM::cruise_height;
...
//	cout<<endl;
	...
	//	cout<<"nodes src,dst= "<<src<<" "<<dst<<endl;
	//	cout<<"quad: "<<_quad_status.x<<" "<<_quad_status.y<<endl;
	//	cout<<"quadv"<<_quad_status.vx<<" "<<_quad_status.vy<<endl;
		for(int oi = 0; oi<_obs_status.size(); oi++){
//			cout<<"obs: "<<_obs_status[oi].x<<" "<<_obs_status[oi].y<<endl;
		}
