...
The tree search params

`tree_search_max_depth : 3`
`tree_search_gama : 0.8`
`tree_search_gama_theta : 0.01`
`tree_search_gama_distance : 0.01`
`tree_search_gama_inner : 0.01`
`tree_search_max_target_counts : 4`
