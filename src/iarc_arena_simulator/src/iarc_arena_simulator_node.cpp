...
void arena_set_startnow(ros::NodeHandle &nh)
{
    if (visited){
    ...
    nh.setParam("time_start_sec", (int)time_offset.sec);
    nh.setParam("time_start_nsec", (int)time_offset.nsec);
